...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error2) && empty($error3) && empty($error4) && empty($error5) && $uploadOk) {
        if (move_uploaded_file($_FILES["user_image"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO userss (role_id, user_image, user_name, user_email, user_phoneNum, password)
...
<body>
    <div class="container">
        <h1>Sign Up</h1>
        <form action="signup4.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
